...
if __name__ == '__main__':
    ...
    for keys in prob_data:
        ...
        hist_x_max = np.min((hist_x_max, 50))
        hist_y_max = 10^4
        ...
        ax_hist1.hist(np.array(cost_sdp), range=(hist_x_min, hist_x_max))
        ax_hist1.set_title('SDP')
        ax_hist1.set_ylim(hist_y_max)
        ...
        ax_hist2.set_title('SQP w/ Multi')
        ax_hist2.set_ylim(hist_y_max)
        # ax_hist2.set_xscale('log')
        ax_hist3 = fig_hist.add_subplot(223, frameon=True)
        ax_hist3.hist(np.array(cost_pgd), range=(hist_x_min, hist_x_max))
        ax_hist3.set_title('PGD')
        ax_hist3.set_ylim(hist_y_max)
        # ax_hist3.set_xscale('log')
        ax_hist4 = fig_hist.add_subplot(224, frameon=True)
        ax_hist4.hist(np.array(cost_rgd), range=(hist_x_min, hist_x_max))
        ax_hist4.set_title('RGD')
        ax_hist4.set_ylim(hist_y_max)
        # ax_hist4.set_xscale('log')
